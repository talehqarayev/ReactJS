...
hearts[1].style.cssText = "background-color: black; border-radius: 50%; height: 80px;";
 ...
 // с помощью этого метода производим операцию над несколькими элементами
...
// circles[2].remove(); // удаляет 3-го элемента из псевдомассива

// hearts[0].replaceWith(circles[0]); // заменяет местами элементов

div.innerHTML = "Hello World!"; // с помощью этого метода добавляет HTML элементы в JavaScript

// div.textContent = "Hello World!"; // разница в том что этот метод работает только с ТЕКСТОМ
